...
//     }
// }
// document.getElementById("stampa").innerHTML="La parola che hai inserito è palindroma? " + checkPalindrome(parola);
...
var controllo = isPal(parola);
console.log(controllo);

console.log(palIs(parola));
